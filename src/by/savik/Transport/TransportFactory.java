...
public class TransportFactory {
    ...
    public static Transport next() {
        ...
        if (i == 0) {
            return new Car(transportName, random.nextInt(120,180),randomPlate, fuelType);
        } else if (i == 1) {
            return new Bike(transportName, random.nextInt(180,280), randomPlate, random.nextBoolean());
        }
        else return new Truck(transportName, random.nextInt(72,150), randomPlate, random.nextInt(5,20));
    }
}
